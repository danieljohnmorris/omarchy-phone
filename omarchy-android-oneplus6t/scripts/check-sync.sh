...
phone/fajita-call-level:.local/bin/fajita-call-level
...
ssh -o ConnectTimeout=8 "$PH" '
  ...
  for u in q6voiced.service 81voltd.service ModemManager.service fajita-backlight-floor.service; do
